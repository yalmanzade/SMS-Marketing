...
namespace E_VilleMarketing.Migrations
{
    ...
    [Migration("20230222194421_UpdateClientBusinessrelation")]
    partial class UpdateClientBusinessrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_VilleMarketing.Models.Business", b =>
                {
                    ...
                    b.HasOne("E_VilleMarketing.Models.Client", null)
                        .WithMany("Businesses")
                        .HasForeignKey("Business");
